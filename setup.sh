...
git clone https://github.com/coolhotham/dev_lav --single-branch -b aosip device/xiaomi/lavender --depth=1
git clone https://github.com/coolhotham/ven_lav --single-branch -b ten vendor/xiaomi/lavender --depth=1
